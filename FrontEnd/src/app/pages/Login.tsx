      ...
      duration: 0.5
        ...
        delay: 0.5
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <button onClick={() => fillDemoAccount('admin@taskhub.com', 'Admin123!')} className="px-3 py-1.5 bg-[#1C1C1E] border border-white/10 rounded-lg text-xs text-white hover:border-[#E31837] hover:bg-[#E31837]/10 transition-all">
              👨‍💼 Admin
            </button>
            <button onClick={() => fillDemoAccount('pm@taskhub.com', 'PM123!')} className="px-3 py-1.5 bg-[#1C1C1E] border border-white/10 rounded-lg text-xs text-white hover:border-[#E31837] hover:bg-[#E31837]/10 transition-all">
              👔 PM
            </button>
            <button onClick={() => fillDemoAccount('dev@taskhub.com', 'Dev123!')} className="px-3 py-1.5 bg-[#1C1C1E] border border-white/10 rounded-lg text-xs text-white hover:border-[#E31837] hover:bg-[#E31837]/10 transition-all">
              👩‍💻 Developer
            </button>
          </div>
        </motion.div>
