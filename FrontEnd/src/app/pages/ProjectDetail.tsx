...
async function createTicket({
  ...
  if (parsedStartDate && parsedDueDate && parsedDueDate < parsedStartDate) {
    throw new Error("La fecha límite no puede ser menor que la fecha inicio");
  }
...
async function updateTicket({
  ...
  const parsedDueDate =
    dueDate !== undefined
      ? parseOptionalDate(dueDate, "dueDate")
      : undefined;

  const finalStartDate =
    parsedStartDate !== undefined ? parsedStartDate : ticket.startDate;

  const finalDueDate =
    parsedDueDate !== undefined ? parsedDueDate : ticket.dueDate;
